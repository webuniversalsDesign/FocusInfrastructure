...
import slide4 from '../../assets/img/home1/banner4.jpg';
import slide5 from '../../assets/img/home1/banner5.jpg';
...
Focus Infrastructures.</p>
            ...
            <SwiperSlide className=" bg-cover img-resp" style={{backgroundImage: `url(${slide4})`}}>
            <div className="overlay-black-trnsprt"/>
                <div className="container">
                    <div className="row">
                        <div className="col-12 ps-md-5 pe-md-5 col-xxl-12 col-lg-12 col-md-8 col-sm-12">
            ...
            <SwiperSlide className=" bg-cover img-resp" style={{backgroundImage: `url(${slide5})`}}>
            <div className="overlay-black-trnsprt"/>
                <div className="container">
                    <div className="row">
                        <div className="col-12 ps-md-5 pe-md-5 col-xxl-12 col-lg-12 col-md-8 col-sm-12">
