...
const Timeline = () => {
  return (
    <section className="company-timeline-wrapper pb-5">
        <div className="container">
           <h3 className='text-center'>We are Expertise in below mentioned Skills set</h3>
           <p className='text-center'>Our projects range are from small businesses to international corporations. We participate in design -build
or design -bid - build, fixed price, and negotiated contracts.
</p>
